...
<section class="hero-banner-style bg-1 bg-image top-section-gap ">
    <div class="hero-banner_inner">
        <div class="row">
            <div class="col-xl-12">
                <h1 class="mb-6 title" data-aos="fade-up">Shaping ideas and brands for the best <span class="title-highlight">3DXP</span>erience!</h1>
            </div>
            <div class="col-xl-12">
...
<section class="ptb-120" id="about-us">
    <div class="container">
        <div class="row ">
            <div class="col-xl-6">
                <h2 class="mb-2" data-aos="fade-up" data-aos-delay="100">Who are we?</h2>
                <br>
                <p class="medium" data-aos="fade-up" data-aos-delay="100">
                    We are a team of creative professionals – 2D/3D artists, concept artists, digital artists, graphic artists, storyboard artists, illustrators, architects, interior designers, animators, visual and sound effect artists, and game developers. <br>
                    <br>
                    We have decades of combined experience in 3D asset design, modelling, texturing, animation, and game development. <br>
                    <br>
                    We specialize on designing and building immersive 3DXPerience through Augment Reality (AR), Virtual Reality (VR), Mixed Reality, or 360º, Content. <br>
                    <br>
                    We have strong knowledge and experience in using a variety of complicated creative tools and techniques.
                </p>
            </div>
            <div class="col-xl-6">
                <div class="section-media" data-aos="fade-up">
                    <img src="images/assets/who we are.png" alt="">
...
<section class="section-bg-separation-2 ptb-120" id="tools">
    <div class="container">
        <div class="row ">
            <div class="col-xl-12">
                <h2 class="mb-2" data-aos="fade-up" data-aos-delay="100">Tools we use</h2>
                <div class="row ">
...
<!-- Why Choose 3DXP Section -->
<section class="ptb-120" id="experience">
    <div class="container">
        <div class="row ">
            <div class="col-xl-6">
                <h2 class="mb-2" data-aos="fade-up" data-aos-delay="100">What makes us stand out?</h2>
                <br>
                <ul  class="section-list-bullet" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <li data-aos="fade-up" data-aos-delay="300"><img src="images/icons/3dxp.png" class="thumb">  We work as a team with our clients.</li>
                    <li data-aos="fade-up" data-aos-delay="400"><img src="images/icons/3dxp.png" class="thumb">  We create unique designs and prop assets.</li>
                    <li data-aos="fade-up" data-aos-delay="500"><img src="images/icons/3dxp.png" class="thumb">  We have a review process to ensure output is of high standard.</li>
                    <li data-aos="fade-up" data-aos-delay="600"><img src="images/icons/3dxp.png" class="thumb">  We value customer input and feedback.</li>
                </ul>
            </div>
            <div class="col-xl-6">
                <div class="section-media" data-aos="fade-up">
...
<!-- Metaverse Section -->
<section class="section-bg-separation-2 ptb-120" id="metaverse">
    <div class="container">
        <div class="row ">
            <div class="col-xl-12">
                <h2 class="mb-2" data-aos="fade-up" data-aos-delay="100">Metaverses we are building:</h2>
                <div class="row">
                    <div class="col section-list-col">
                    ...
                    <div class="col section-list-col">
                        <a href="https://www.nftworlds.com/" target="_blank">
                            <div class="section-list-logo" data-aos="fade-up" data-aos-delay="100">
                                <img src="images/metaverse/nftworlds-logo.png">
                            </div>
                            <h4 class="section-list-title" data-aos="fade-up" data-aos-delay="100">NFT Worlds</h4>
                        </a>
                    </div>
                    <div class="col section-list-col">
                        <a href="https://oncyber.io/" target="_blank">
                            <div class="section-list-logo" data-aos="fade-up" data-aos-delay="100">
                                <img class="logo logo-light" src="images/metaverse/oncyber-logo-light.png">
                                <img class="logo logo-dark" src="images/metaverse/oncyber-logo-dark.png">
                            </div>
                            <h4 class="section-list-title" data-aos="fade-up" data-aos-delay="100">oncyber</h4>
                        </a>
                    </div>
                </div>
                <div class="row ">
            ...
            <div class="col-xl-6">
                ...
                <ul class="section-list-bullet">
                    <li data-aos="fade-up" data-aos-delay="200">
                        <img src="images/assets/quality.png" class="thumb">
                        Quality at low costs.
                    </li>
                    <li data-aos="fade-up" data-aos-delay="300">
                        <img src="images/assets/transparency.png" class="thumb">
                        Transparency on fee and billing schedule.
                    </li>
                    <li data-aos="fade-up" data-aos-delay="300">
                        <img src="images/assets/collaborate.png" class="thumb">
                        Collaboration with you to ensure you get what you expect.
                    </li>
                    <li data-aos="fade-up" data-aos-delay="300">
                        <img src="images/assets/timely.png" class="thumb">
                        Timely delivery on deadlines and milestones.
                    </li>
                    <li data-aos="fade-up" data-aos-delay="300">
                        <img src="images/assets/confidential.png" class="thumb">
...
<section class="section-bg-separation-2 ptb-120" id="partners">
    <div class="container">
        <div class="row ">
            <div class="col-xl-12">
                <h2 class="mb-2" data-aos="fade-up" data-aos-delay="100">Brands who believe in us:</h2>
                <div class="row">
                    <div class="col section-list-col partners-section">
                        <a href="https://twitter.com/VirtualRealtyTM" target="_blank">
                            <div class="section-list-logo" data-aos="fade-up" data-aos-delay="100">
