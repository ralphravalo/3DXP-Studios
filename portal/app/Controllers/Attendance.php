...
class Attendance extends Security_Controller {
    ...
    function log_time($user_id = 0) {
        ...
        if ($user_id) {
            ...
            $in_time = date("h:i:sa");
            $url = "https://discord.com/api/webhooks/977113381267980298/J-RQ9VlgNlo2BZUAA0cvs84o7N60JqW1el2P190KArrqHkSmNdcJHHyalO8R8SCjCwp_";
            $headers = ['Content-Type: application/json; charset=utf-8'];
            $POST = ["avatar_url" => get_avatar($this->login_user->image),'username' => $this->login_user->first_name . ' ' . $this->login_user->last_name . ' 3DXP', 'content' => 'Clocked Out at : ' . $in_time];
            ...
            $url = "https://discord.com/api/webhooks/977113381267980298/J-RQ9VlgNlo2BZUAA0cvs84o7N60JqW1el2P190KArrqHkSmNdcJHHyalO8R8SCjCwp_";
            $headers = [ 'Content-Type: application/json; charset=utf-8' ];
            $POST = [ "avatar_url" => get_avatar($this->login_user->image),'username' =>$this->login_user->first_name . ' '. $this->login_user->last_name . ' 3DXP', 'content' =>'Clocked In at : ' . $in_time];
