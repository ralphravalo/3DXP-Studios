                                    ...
                                    <div class="row">
                                        ...
                                        <div class="upload-area" id="form-step-3">
                                            ...
                                            <div class="brows-file-wrapper">
                                                <input name="exp-attachments[]" id="file" type="file" class="inputfile"
                                                       data-multiple-caption="{count} files selected" multiple />
                                                <label for="file" title="No File Choosen">
                                                    <i class="ri-upload-cloud-line"></i>
                                                    <span class="text-center mb-2">Choose a File</span>
                                                    <span class="file-type text-center mt--10">PNG, JPG, JPEG or PDF <br> Up to 5 files only.</span>
                                                </label>
                                            </div>
                                        </div>
                                        <!-- end upoad file area -->
...
<div class="modal fade popup" id="deposit-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-deposit" role="document">
            ...
            <div class="modal-body pa-8">
                <div class="row">
                    <div class="col-xl-6 text-center">
                        <div class="deposit-image-popup mb-4"> <img src="images/QR.png" alt="wallet-qr"></div>
                        <h2 style="font-size: 23px;" class="mb-4">You're almost there!</h2>
                        <p class="mb-4" style="line-height: 1; font-size: 14px;">Please double check the wallet address in case you use the QR code!</p>
                        <div class="tooltip">
                            <p class="medium" style="line-height: 1.4; font-size: 14px;"><b>Wallet address (Cardano)</b>
                            <a class="link-info" href="javascript:void(0);" onclick="copyFunc()" onmouseout="outFunc()">addr1q93evgh7wzr8ykq5p064y82l8xe7hc2n5k9z<br>gtyl669vspu3prsl5khjdamwxum0gx3jucwwp4sk8t<br>8tnyn7zl6t20hqrmyyxq
                        ...
                        <div class="tooltip">
                            <p class="medium" style="line-height: 1.4; font-size: 14px;"><b>ADA Handle:</b>
                            <a class="link-info" href="javascript:void(0);" onclick="copyFuncHandle()" onmouseout="outFuncHandle()">$3dxp.design
                                <span class="tooltiptext" id="myHandleTooltip">Copy to Clipboard</span>
                            </a>
                            </p>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <form class="deposit__form" method="post" action="depositmail.php">
                            <!-- form message -->
                            <div class="row">
                                <div class="col-12">
                                    <div class="deposit__msg" style="display: none">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    <div class="field-box">
                                        <input name="dep-nickname" id="nickname" type="text" placeholder="Confirm your Nickname" required>
                                    </div>
                                </div>
                                <!-- End .col -->
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="field-box">
                                        <input name="dep-transid" id="transactionid" type="text" placeholder="Transaction ID" required>
                                    </div>
                                </div>
                                <!-- End .col -->
                            </div>
                            <!-- End .row -->
                            <div class="g-recaptcha" data-sitekey="6Lc5NbkfAAAAAP_sYDzI7sJbUOxPlbRDvRoQYEc6"></div><br>
                            <div class="mt-0">
                                <button class="btn btn-gradient btn-medium justify-content-center" style="width: 100%;" type="submit" name="dep-submit"><span>Minimum deposit paid</span></button>
                            </div>
                        </form>
                    </div>
                </div>
