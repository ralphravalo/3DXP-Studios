...
<footer class="footer-wrapper">
                ...
                <div class="col-lg-8 col-md-6 mb-8">
                    <div class="footer-widget first-block">
                        ...
                        <br>We have decades of combined experience in 3D asset design, 3D animation, and game development. Our team have strong knowledge and experience
                            ...
                            We are owned by 3DXP a limited company based in London, United Kingdom.<br><br>
                ...
                <div class="col-lg-2 col-md-6 mb-8">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-list-widget">
                            ...
                            <li><a href="index.php#experience">3DXPerience</a></li>
    ...
    <div class="copyright text-center">
        <div class="container">
            <p>© 2022 <a href="#" target="_blank">3DXP Design Studio.</a> All Rights
                Reserved.</p>
        </div>
    </div>
